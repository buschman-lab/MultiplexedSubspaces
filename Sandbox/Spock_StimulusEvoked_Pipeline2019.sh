...
#SBATCH -J 'SensoryProV2'
#SBATCH -o out/SensoryProV2_output_%j.out
#SBATCH -p all
#SBATCH -t 55
...
cd "/jukebox/buschman/Rodent Data/Wide Field Microscopy/AnalysisCode_Repository/Spock_Processing/SensoryMapping_Spock/"
...
xvfb-run -d matlab -nosplash -nodisplay -nodesktop -r "try; StimulusEvoked_Pipeline2019_Spock($SLURM_ARRAY_TASK_ID); catch me; fprintf('Error: %s / %s\n',me.identifier,me.message); for k=1:length(me.stack), me.stack(k), end; end; exit"
