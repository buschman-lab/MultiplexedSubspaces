...
% discovery, and motif fitting of 1 animal. It requires a computing cluster
% (e.g. spock at princeton). 
...
% group = [{1},{0},{2}];
group = [{2}];
dynamics = 3; %0 = flattened motifs, 1 = normal, 2 = reversed motifs, 3=single frame average
for i = 1:numel(group)   
