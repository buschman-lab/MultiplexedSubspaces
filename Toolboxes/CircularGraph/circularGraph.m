...
% Copyright 2016 The MathWorks, Inc.
  properties
    ...
    normVal;          % Normalization of line thickness value | Added Camden 
  end
  ...
  methods
    function this = circularGraph(adjacencyMatrix,varargin)
      ...
      defaultNorm = nanmax(adjacencyMatrix(:));
...
%         'CloseRequestFcn',@circularGraph.CloseRequestFcn);
      ...
      minLineWidth  = 0.25; 
      lineWidthCoef = 2; %def =5      
      lineWidth = v./this.normVal; 
%       lineWidth = v.^this.normVal; 
