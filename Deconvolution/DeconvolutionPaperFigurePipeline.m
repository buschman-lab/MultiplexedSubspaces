...
for cur_rec = 1:n_rec
    for cur_probe = 1:n_probe
       ...
       for cur_method = 1:size(ypred,2)+1        
           ...
           p.LineWidth=2; box on           
       end
    end
end

%% Example traces withheld data
...
fp = fig_params_deconvolutionpaper; 
fn(1) = GrabFiles('within_comparedepthsstd6.mat',0,{'Z:\Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\Deconvolution'});
fn(2) = GrabFiles('within_xsite\w*std\w*.mat',0,{'Z:\Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\Deconvolution'});
fn(3) = GrabFiles('xrec_xsite\w*std\w*.mat',0,{'Z:\Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\Deconvolution'});
fn(4) = GrabFiles('xanimals\w*std\w*.mat',0,{'Z:\Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\Deconvolution'});
